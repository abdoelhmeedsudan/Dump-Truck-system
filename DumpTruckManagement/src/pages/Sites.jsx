...
import { siteApi, extractPaginatedData, extractObjectFromResponse } from '../services/apiService'
...
export default function Sites() {
  ...
  async function handleEdit(item) {
    try {
      const response = await siteApi.getById(item.id)
